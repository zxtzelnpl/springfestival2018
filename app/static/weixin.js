...
const weixin = ({APPid,timestamp,nonceStr,signature}) => {
  wx.config({
  ...
  wx.ready(function(){
    wx.onMenuShareTimeline({
      title: '狗年旺旺旺',
      link: 'http://new.cjtglm.com/buildspring/index.html', /*分享链接*/
      imgUrl: 'http://public.jyzqsh.com/spring/share.jpg', /*分享图片*/
      success: function () {
